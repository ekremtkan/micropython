...
class Logger:
    ...
    def debug(self, msg, *args):
        self.log(_DEBUG, msg, *args)

    def info(self, msg, *args):
        self.log(_INFO, msg, *args)

    def warning(self, msg, *args):
        self.log(_WARNING, msg, *args)

    def error(self, msg, *args):
        self.log(_ERROR, msg, *args)

    def critical(self, msg, *args):
        self.log(_CRITICAL, msg, *args)
...
def basicConfig(level=_INFO, filename=None, stream=None, format=None):
